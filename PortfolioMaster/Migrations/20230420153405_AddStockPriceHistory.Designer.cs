...
namespace PortfolioMaster.Migrations
{
    ...
    [Migration("20230420153405_AddStockPriceHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioMaster.Models.CryptoAssetPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CryptoAssetType")
                        .IsRequired()
            ...
            modelBuilder.Entity("PortfolioMaster.Models.StockPriceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PortfolioMaster.Models.BankAccount", b =>
                {
            ...
            modelBuilder.Entity("PortfolioMaster.Models.CryptoAsset", b =>
                {
                    b.HasBaseType("PortfolioMaster.Models.Asset");
                    ...
                    b.HasDiscriminator().HasValue("CryptoAsset");
                });
            ...
            modelBuilder.Entity("PortfolioMaster.Models.Stock", b =>
                {
                    ...
                    b.Property<decimal>("DividendCAGR")
                        .HasColumnType("decimal(18, 4)");
                    ...
                    b.Property<decimal>("High52WeekPrice")
                        .HasColumnType("decimal(18, 4)");

                    b.Property<decimal>("Low52WeekPrice")
                        .HasColumnType("decimal(18, 4)");
                    ...
                    b.Property<decimal>("PriceToEarningsRatio")
                        .HasColumnType("decimal(18, 4)");
            ...
            modelBuilder.Entity("PortfolioMaster.Models.VentureCapital", b =>
                {
                    b.HasBaseType("PortfolioMaster.Models.Asset");

                    b.HasDiscriminator().HasValue("VentureCapital");
                });
            ...
            modelBuilder.Entity("PortfolioMaster.Models.StockPriceHistory", b =>
                {
                    b.HasOne("PortfolioMaster.Models.Stock", "Stock")
